...
def main():
    ...
    # Load SPY 2-year data
    print("Loading 2-year SPY data...")
    spy_file = data_dir / 'SPY_2year.csv'
    ...
    # Save
    output_file = output_dir / 'spy_features_2year.csv'
